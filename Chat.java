...
public class Chat {
    ...
    static ChatBotUtils chatUtils=  new ChatBotUtils();
    ...
    @OnOpen
    public void start(Session session,@PathParam("client-id") String name) throws IOException {
	...
	hm.put(nickname, session);
        ...
        this.session.getBasicRemote().sendText(connected.toString());
        broadcast( "Hi, Welcome to RMK Technology Chatbot", nickname, nickname);
    ...
    public void incoming(String message) {
		...
		String response =chatUtils.getTheResponseBasedOnRequest(session,jsonMessage,nickname);
		
		
		
		broadcast( response, nickname, nickname);
